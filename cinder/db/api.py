...
def micro_states_create(context, values):
    ...
    return IMPL.micro_states_create(context, values)
...
def micro_states_update(context, resource_id, values):
    ...
    """
    return IMPL.micro_states_update(context, resource_id, values)


def micro_states_destroy(context, resource_id):
    """Destroy the micro_states record ."""
    return IMPL.micro_states_destroy(context, resource_id)
